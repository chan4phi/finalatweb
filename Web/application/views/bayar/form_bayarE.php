...
<?php echo form_open('pembayaran/submit',array('id'=>'form_bayarE')); ?>
	<fieldset>
    <input type="hidden" name="KdBR" value="<?php echo $bayar[0]->KdBR; ?>">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" readonly name="Penerima" value="<?php echo $this->session->userdata('NamaPengguna'); ?>">
			</div>
		</div>
	...
	<fieldset>
		...
		<label  class="col-sm-2 col-form-label">Kode Booking</label>
			<div class="col-sm-10">
				<div class="input-group">
					<input type="text" class="form-control" value="<?php echo $bayar[0]->KdBO; ?>" id="KdBO" name="KdBO" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<div class="input-group">
					<input type="text" class="form-control" value="<?php echo $bayar[0]->CustomerID; ?>" id="CustomerID" name="CustomerID" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<div class="input-group">
				<input type="date" readonly id="TgglStart" value="<?php echo $bayar[0]->TgglStart; ?>" class="form-control" name="TgglStart">
				</div>
			</div> 
		...
		<div class="form-group row">
			...
			<div class="col-sm-5">
				<div class="input-group">
					<input type="text" class="form-control" value="<?php echo $bayar[0]->BisID; ?>" id="BisID" name="BisID" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-sm-5">
				<div class="input-group">
				<input type="text" readonly class="form-control" value="<?php echo $bayar[0]->Jenis; ?>" id="Jenis" name="Jenis">
				</div>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<div class="input-group">
				<input type="text" class="form-control" value="<?php echo $bayar[0]->HargaSewa; ?>" readonly id="HargaSewa" name="HargaSewa">
				</div>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				...
				<input type="text" class="form-control" value="<?php echo $bayar[0]->Terbayar; ?>" onkeyup="calc()" id="Terbayar" name="Terbayar">
        ...
        <div class="form-group row">
			...
			<div class="col-sm-2">
				<input type="text" readonly class="form-control" value="<?php echo $bayar[0]->SisaBayar; ?>" id="SisaBayar" name="SisaBayar">
			</div>
		</div>
...
$(document).ready(function(){
	...
	$('#btn_submitData').click(function(){
		$.ajax({
			url:"<?php echo site_url('pembayaran/update'); ?>",
			type:'POST',
			dataType:'json',
			data:$('#form_bayarE').serialize(),
