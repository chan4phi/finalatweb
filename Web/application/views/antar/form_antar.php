...
<?php echo form_open('antar/submit',array('id'=>'form_antar')); ?>
	<fieldset>
	...
	<fieldset>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<div class="input-group">
					<input type="text" class="form-control" id="KdBR" name="KdBR" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<div class="input-group">
					<input type="text" class="form-control" id="NamaCustomer" name="NamaCustomer" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<div class="input-group">
					<input type="text" class="form-control" id="AlmtJemput" name="AlmtJemput" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="JamStart" name="JamStart">
				</div>
			</div>	
		</div>	
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<div class="input-group">
				<input type="date" readonly id="TgglFinish"  class="form-control" name="TgglFinish">
				</div>
			</div>  
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="JamFinish" name="JamFinish">
				</div>
			</div>	
		</div>	
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" readonly class="form-control" id="Standby" name="Standby">
				</div>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="Overtime" name="Overtime">
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="Tujuan" name="Tujuan">
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="Jenis1" name="Jenis1">
				</div>
			</div>
		</div>
	</fieldset>
	...
	<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="NoPol" name="NoPol">
				</div>
			</div>
		</div>
	<div class="form-group row">
		...
		<div class="col-sm-4">
			<div class="input-group">
				<input type="text" class="form-control" id="DriverID" name="DriverID" readonly>
				<div class="input-group-append">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="NamaDriver" name="NamaDriver">
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control"  id="PremiDriver" name="PremiDriver">
				</div>
			</div>
		</div>
		...
		<div class="col-sm-4">
			<div class="input-group">
				<input type="text" class="form-control" id="AsistenID" name="AsistenID" readonly>
				<div class="input-group-append">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="NamaAsisten" name="NamaAsisten">
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" id="PremiAsisten" name="PremiAsisten">
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" id="Solar" name="Solar">
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" onkeyup="calc2()" class="form-control" id="Tol" name="Tol">
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" id="KmStart" name="KmStart">
				</div>		
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" id="KmFinish" name="KmFinish">
				</div>			
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" readonly id="BiayaOvertime" name="BiayaOvertime">
				</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-1">
				<div class="input-group">
				<input type="number" onblur="calc()" step="0.1" id="durasi" name="durasi">
				</div>	
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<div class="input-group">
				<input type="text" class="form-control" value="0" readonly id="Kasbon" name="Kasbon">
				</div>			
			</div>
		</div>
...
<div class="modal fade" id="driverModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Dialog Informasi Driver</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="asistenModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Dialog Informasi Asisten</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
$(document).ready(function(){
    ...
    var table = $('#driverTable2').DataTable();
	...
	$('#btn_submitData').click(function(){
		$.ajax({
			url:"<?php echo site_url('antar/submit'); ?>",
			type:'POST',
			dataType:'json',
			data:$('#form_antar').serialize(),
